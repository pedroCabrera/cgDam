...
[Registry]
Root: "HKLM"; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; ValueType: string; ValueName: "CgDamROOT"; ValueData: "{autopf}\{#MyAppName}"; Flags: preservestringtype deletevalue
...
Name: "{commonprograms}\cgDam Adobe Substance 3D Painter"; Filename: "{#SPP}"; Check: Not FileExists(ExpandConstant('{commonprograms}\spp.lnk')); Parameters: "--enable-remote-scripting"; IconFilename: "{#SPP}";
